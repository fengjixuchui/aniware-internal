...
namespace render
{
	...
	void corner( const math::vec2_t& pos, const math::vec2_t& size, const col_t& col )
	{
		set_color( col );
		ctx::csgo.surface->DrawLine( static_cast< int >( pos.x ), 
								  	 static_cast< int >( pos.y ), 
									 static_cast< int >( pos.x ), 
									 static_cast< int >( pos.y ) + ( static_cast< int >( size.y ) / 5 ) );

		ctx::csgo.surface->DrawLine( static_cast< int >( pos.x ), 
									 static_cast< int >( pos.y ), 
									 static_cast< int >( pos.x ) + (static_cast< int >( size.x ) / 5 ), 
									 static_cast< int >( pos.y ) );

		ctx::csgo.surface->DrawLine( static_cast< int >( pos.x ) + static_cast< int >( size.x ), 
									 static_cast< int >( pos.y ), 
									 static_cast< int >( pos.x ) + static_cast< int >( size.x ) - ( static_cast< int >( size.x ) / 5 ), 
									 static_cast< int >( pos.y ) );
		
		ctx::csgo.surface->DrawLine( static_cast< int >( pos.x ) + static_cast< int >( size.x ),
									 static_cast< int >( pos.y ), 
									 static_cast< int >( pos.x ) + static_cast< int >( size.x ), 
									 static_cast< int >( pos.y ) + ( static_cast< int >( size.y ) / 5 ) );
		
		ctx::csgo.surface->DrawLine( static_cast< int >( pos.x ),
									 static_cast< int >( pos.y ) + static_cast< int >( size.y ), 
									 static_cast< int >( pos.x ) + ( static_cast< int >( size.x ) / 5 ),
									 static_cast< int >( pos.y ) + static_cast< int >( size.y ) );
		...
		ctx::csgo.surface->DrawLine( static_cast< int >( pos.x ), 
									 static_cast< int >( pos.y ) + static_cast< int >( size.y ),
									 static_cast< int >( pos.x ), 
									 static_cast< int >( pos.y ) + static_cast< int >( size.y ) - ( static_cast< int >( size.y ) / 5 ) );
